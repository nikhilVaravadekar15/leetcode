...
export default function Timer() {
    ...
    return (
        <div>
            {showTimer ? (
                <div className="flex items-center space-x-2 text-white bg-dark-fill-3 p-1.5 cursor-pointer rounded hover:bg-dark-fill-2">
                ...
                <Button
                    className="h-full flex items-center p-1 text-dark-gray-6 rounded cursor-pointer hover:text-white hover:bg-dark-fill-3"
