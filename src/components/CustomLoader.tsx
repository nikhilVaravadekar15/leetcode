...
export default function CustomLoader() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="http://www.w3.org/1999/xlink" width="64px"
            height="64px"
            ...
            <g filter="url(#fl_bOT9wWwCcmOdD0DrJ3W8W)">
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="1" className="fill-[#e9c46a] scale-[0.3]"></circle>
                    </g>
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="2" className="fill-[#e9c46a] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="3" className="fill-[#e9c46a] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="4" className="fill-[#e9c46a] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="5" className="fill-[#e9c46a] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="6" className="fill-[#e9c46a] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="7" className="fill-[#e9c46a] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="8" className="fill-[#e9c46a] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="9" className="fill-[#e9c46a] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="10" className="fill-[#e9c46a] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="11" className="fill-[#e9c46a] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="12" className="fill-[#e9c46a] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="13" className="fill-[#e9c46a] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="14" className="fill-[#e9c46a] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="15" className="fill-[#e9c46a] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="16" className="fill-[#e9c46a] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="17" className="fill-[#f4a261] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="18" className="fill-[#f4a261] scale-[0.3]"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
                ...
                <g>
                    <g transform="translate(50 36)">
                        <circle cx="0" cy="0" r="19" className="fill-[#f4a261] scale-[0.3]" transform="scale(0.3)"></circle>
                    </g>
                    <animateTransform attributeName="transform" calcMode="spline" type="rotate"
                        values="0 50 50;360 50 50"
