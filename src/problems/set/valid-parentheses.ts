...
import { TExample, TProblemLocal, TSolution } from '@/types/index';
...
const problemStatement: string = `<p class='mt-3'>
    Given a string <code>s</code> containing just the characters <code>'('</code>, <code>')'</code>, <code>'{'</code>,
    <code>'}'</code>, <code>'['</code> and <code>']'</code>, determine if the input string is valid.</p>
...
const constraints: string = `<li class='mt-2'><code>1 <= s.length <= 10<sup>4</sup></code></li>
